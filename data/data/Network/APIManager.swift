...
//        authProvider.requestPublisher(.register(email: email, password: password, name: name))
//    }
//
//    // MARK: Mypage - AUTHmanager
//
...
//        authProvider.requestPublisher(.changeNickname(name: name))
//    }
//
//    func addStudent(number: Int) -> AnyPublisher<Void, MoyaError> {
//        authProvider.requestPublisher(.addStudent(number: number))
//    }
//
...
//        authProvider.requestPublisher(.changePassword(password: password, prePassword: prePassword))
//    }
//
